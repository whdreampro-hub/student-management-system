...
<head>
    ...
    <title>Transfer Student | Student Management System</title>
        ...
        <div class="row">
            ...
            <div class="col-md-10 main-content p-4">
                <div class="transfer-card">
                    <h4 class="mb-4"><i class="fas fa-exchange-alt"></i> Transfer Student</h4>
                    ...
                    <form method="POST" action="">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="remarks" class="form-control" rows="3" required placeholder="Enter reason for transfer..."></textarea>
                            </div>
                        </div>
