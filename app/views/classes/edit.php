...
<body>
    <div class="d-flex">
        ...
        <div class="main-content p-4 w-100">
            <header class="mb-4">
                <h1><i class="bi bi-pencil me-2"></i> Edit Class</h1>
            </header>
            ...
            <form action="/student-management/public/index.php?controller=class&action=update&id=<?= $class['id'] ?>" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="level" name="level"
                                   value="<?= htmlspecialchars($class['level'] ?? '') ?>" placeholder="e.g. Primary, Secondary">
                        </div>
                    </div>
                </div>
