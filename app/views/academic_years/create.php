...
<head>
    ...
    <title>Add Academic Year - Student Management System</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    <div class="d-flex">
        ...
        <nav class="sidebar">
            <div class="p-3">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="/student-management/public/index.php?controller=academic_year&action=create">
        ...
        <div class="main-content p-4">
            <header class="mb-4">
                <h1><i class="bi bi-plus-lg me-2"></i> Add New Academic Year</h1>
            </header>
            ...
            <form action="/student-management/public/index.php?controller=academic_year&action=store" method="POST">
                ...
                <div class="form-section">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="year_name" name="year_name" placeholder="e.g., 2025-2026" required>
                        </div>
                        <div class="col-md-6">
